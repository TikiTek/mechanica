	...
	while(number_items --)
	{
		...
		switch(rootkey)
		{
			case 0:
				...
				else if(strcmp((const char*)keychar, "phase") == 0)
				{
			...
			case 'bvlS':
				...
				switch(key)
				{
					...
					case 'PlEb':
						...
						break;
					case 0:
						if(strcmp((const char*)keychar, "strokeEmboss") == 0)
