...
namespace tiki
{
	namespace simd
	{
		...
		TIKI_SIMD_INLINE vf32	set_f32( const float* pValues, const uintreg offset );
		TIKI_SIMD_INLINE vf32	set_f32u( const float* pValues );
		TIKI_SIMD_INLINE vf32	set_f32u( const float* pValues, const uintreg offset );
		...
		TIKI_SIMD_INLINE vi32	set_i32( const sint32* pValues, const uintreg offset );
		TIKI_SIMD_INLINE vi32	set_i32u( const sint32* pValues );
		TIKI_SIMD_INLINE vi32	set_i32u( const sint32* pValues, const uintreg offset );
		...
		TIKI_SIMD_INLINE void	get_f32( float* pTarget, const uintreg offset, const vf32 value );
		...
		TIKI_SIMD_INLINE void	get_i32( sint32* pTarget, const uintreg offset, const vi32 value );
		...
		//TIKI_SIMD_INLINE void	get_i16( sint16* pTarget, const uintreg offset, const vi16 value );
		...
		//TIKI_SIMD_INLINE void	get_i8( sint8* pTarget, uintreg offset, vi8 value);
		...
		//TIKI_SIMD_INLINE void	get_u32( sint32* pTarget, uintreg offset, vu32 value);
		...
		//TIKI_SIMD_INLINE void	get_u16( sint16* pTarget, uintreg offset, vu16 value);
		...
		//TIKI_SIMD_INLINE void	get_u8( sint8* pTarget, uintreg offset, vu8 value);
		...
		//TIKI_SIMD_INLINE vf32	shuffle_f32( const vf32 v1, const vf32 v2, uintreg mask );
