...
namespace tiki
{
	...
	public:
									...
									GenericDataTypeValueType( GenericDataTypeCollection& collection, const DynamicString& name, const DynamicString& filename, GenericDataTypeMode mode, GenericDataValueTypeType type );
