...
namespace tiki
{
	static const char* s_apKeyboardKeyStrings[ KeyboardKey_Count ] =
	{
		"KeyboardKey_Escape",
	...
	const char* input::getKeyboardKeyName( KeyboardKey key )
	{
		TIKI_ASSERT( key < KeyboardKey_Count );
		return s_apKeyboardKeyStrings[ key ];
	}
}
