...
enum D3D11_FORMAT_SUPPORT2
    {
        ...
        D3D11_FORMAT_SUPPORT2_TILED_VOLUMES	= 0x800,
        D3D11_FORMAT_SUPPORT2_JPEG_DECODE	= 0x1000,
        D3D11_FORMAT_SUPPORT2_JPEG_ENCODE	= 0x2000
...
enum D3D11_QUERY
    {
        ...
        D3D11_QUERY_JPEG_DECODE_EVENT	= ( D3D11_QUERY_SO_OVERFLOW_PREDICATE_STREAM3 + 1 ) ,
        D3D11_QUERY_JPEG_ENCODE_STATISTICS	= ( D3D11_QUERY_JPEG_DECODE_EVENT + 1 ) 
    } 	D3D11_QUERY;
...
enum D3D11_FEATURE
    {
        ...
        D3D11_FEATURE_JPEG_OPTIONS	= ( D3D11_FEATURE_D3D11_OPTIONS2 + 1 ) 
    } 	D3D11_FEATURE;
...
enum D3D11_CONTENT_PROTECTION_CAPS
    {
        ...
        D3D11_CONTENT_PROTECTION_CAPS_HARDWRE_PROTECTED_MEMORY_PAGEABLE	= 0x1000
...
typedef HRESULT (WINAPI* PFN_D3D11_CREATE_DEVICE)( _In_opt_ IDXGIAdapter*, 
    ...
    UINT FeatureLevels, UINT, _Out_opt_ ID3D11Device**, 
