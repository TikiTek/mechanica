...
CURLcode Curl_init_userdefined(struct UserDefined *set)
{
  ...
  set->httpreq = CURL_HTTPREQ_GET; /* Default HTTP request */
                     ...
                     va_list param)
{
  ...
  case CURLOPT_PUT:
    ...
    if(data->set.upload) {
      ...
      data->set.httpreq = CURL_HTTPREQ_PUT;
  ...
  case CURLOPT_POST:
    ...
    if(va_arg(param, long)) {
      data->set.httpreq = CURL_HTTPREQ_POST;
      data->set.opt_no_body = FALSE; /* this is implied */
    }
    else
      data->set.httpreq = CURL_HTTPREQ_GET;
  ...
  case CURLOPT_HTTPPOST:
    ...
    data->set.httpreq = CURL_HTTPREQ_POST_FORM;
    data->set.opt_no_body = FALSE; /* this is implied */
    break;
                                 ...
                                 const struct connectdata *conn)
{
  if((conn->handler->protocol & PROTO_FAMILY_HTTP) &&
     ...
     (handle->set.httpreq == CURL_HTTPREQ_GET ||
      handle->set.httpreq == CURL_HTTPREQ_HEAD) &&
...
static CURLcode do_init(struct connectdata *conn)
{
  ...
  else if(CURL_HTTPREQ_HEAD == data->set.httpreq)
