...
namespace tiki
{
	ComponentPool< SkinnedModelComponent > SkinnedModelComponent::s_pool;

	Buffer< SkinnedModelComponent::Pose, 4u > SkinnedModelComponent::s_skinningBuffer;

	void SkinnedModelComponent::initializeSystem()
	{
		//s_skinningBuffer.create();
	}
